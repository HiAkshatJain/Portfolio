    ...
    >
      ...
      <div className="z-10">
        ...
        <div className="socials flex flex-row gap-4">
          <Link
            href="https://github.com/HiAkshatJain"
            target="_blank"
            rel="noopener noreferrer"
          >
            <FaGithub className="text-white hover:text-[#e84949] text-2xl" />
          </Link>
          <Link
            href="https://www.linkedin.com/in/hiakshatjain/"
            target="_blank"
            rel="noopener noreferrer"
          >
            <FaLinkedin className="text-white hover:text-[#e84949] text-2xl" />
          </Link>
        </div>
      </div>
      <div>
